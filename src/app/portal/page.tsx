...
const HOW_IT_WORKS = [
  {
    ...
    desc: "Fill out the simple form with your details and a description of your complaint. Upload supporting documents if any.",
    icon: FileText,
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-950 via-brand-800 to-brand-600 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-brand-100 max-w-xl mb-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/submit"
                className="inline-flex items-center gap-2 bg-white text-brand-700 hover:bg-brand-50 font-semibold px-6 py-3 rounded-xl transition-colors shadow-lg"
              >
      ...
      <div className="bg-amber-50 border-y border-amber-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-sm text-amber-800">
          ...
          <div className="flex items-center gap-2 font-medium">
            ...
            Mandatory official authority response
          </div>
        </div>
      </div>
      ...
      <section className="bg-brand-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          <h2 className="text-2xl font-bold mb-3">Have a grievance? We&apos;re here to help.</h2>
          <p className="text-brand-200 mb-6">
            Submit now and receive your Ticket ID instantly.
          </p>
          <Link
            href="/submit"
            className="inline-flex items-center gap-2 bg-white text-brand-700 hover:bg-brand-50 font-semibold px-8 py-3 rounded-xl transition-colors"
          >
            <FileText className="h-5 w-5" />
            File a Grievance
            <ArrowRight className="h-4 w-4" />
